 ...
 */
function hag_theme_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL)  {
  // Work-around for a core bug affecting admin themes. See issue #943212.
  if (isset($form_id)) {
    return;
  }
  $form['hag_theme_custom'] = array(
    '#type' => 'fieldset',
  ...
  $form['hag_theme_custom']['hag_theme_front_background'] = array(
    '#type' => 'fieldset',
    '#title' => t('Frontpage background image settings'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  $form['hag_theme_custom']['hag_theme_front_background']['hag_background_collection_pid'] = array(
    '#type' => 'textfield',
  ...
  $form['hag_theme_custom']['hag_theme_front_background']['hag_background_dsid'] = array(
    '#type' => 'textfield',
